local BUILD_ID = "MS-20260528152357-A5E91A9F"
...
local REQUEST_FEATURES = "• Universal GUI | • AimBot"
...
gui.Name = "MistralScriptsGui" .. "_" .. "EF745B"
...
main.Size = UDim2.new(0, 306, 0, 424)
main.Position = UDim2.new(0.5, -153, 0.5, -212)
...
local function addToggle(text, callback)
    ...
    button.MouseButton1Click:Connect(function()
        ...
        button.BackgroundColor3 = enabled and Color3.fromRGB(99, 58, 168) or Color3.fromRGB(54, 31, 90)
    ...
    if state and root then
        flyConn = RunService.RenderStepped:Connect(function()
            ...
            if move.Magnitude > 0 then
                hrp.AssemblyLinearVelocity = move.Unit * flySpeed + Vector3.new(0, 6, 0)
            else
