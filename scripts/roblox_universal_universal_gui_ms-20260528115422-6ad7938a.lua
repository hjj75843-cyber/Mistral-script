local BUILD_ID = "MS-20260528115422-6AD7938A"
...
gui.Name = "MistralScriptsGui" .. "_" .. "98D6E8"
...
main.Size = UDim2.new(0, 307, 0, 408)
main.Position = UDim2.new(0.5, -153, 0.5, -204)
main.BackgroundColor3 = Color3.fromRGB(20, 14, 32)
main.BorderSizePixel = 0
main.Parent = gui
local mainCorner = Instance.new("UICorner")
mainCorner.CornerRadius = UDim.new(0, 21)
...
local function makeBaseButton(text)
    ...
    button.BackgroundColor3 = Color3.fromRGB(48, 30, 82)
...
local function addToggle(text, callback)
    ...
    button.MouseButton1Click:Connect(function()
        ...
        button.BackgroundColor3 = enabled and Color3.fromRGB(99, 58, 168) or Color3.fromRGB(48, 30, 82)
    ...
    if state and root then
        flyConn = RunService.RenderStepped:Connect(function()
            ...
            if move.Magnitude > 0 then
                hrp.AssemblyLinearVelocity = move.Unit * flySpeed + Vector3.new(0, 4, 0)
            else
