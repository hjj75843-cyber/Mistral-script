...
gui.Name = "MistralScriptsGui" .. "_" .. "0DE507"
...
main.Size = UDim2.new(0, 309, 0, 416)
main.Position = UDim2.new(0.5, -154, 0.5, -208)
...
gradient.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(38, 19, 72)), ColorSequenceKeypoint.new(1, Color3.fromRGB(18, 11, 32))})
gradient.Rotation = 67
